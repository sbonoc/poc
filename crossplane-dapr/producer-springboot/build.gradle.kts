...
dependencies {
    ...
    add("contractTestImplementation", "au.com.dius.pact.provider:junit5:4.6.17")
}
...
tasks.named("contractTest") {
    dependsOn(":consumer-springboot:contractTest")
}

tasks.named<Test>("contractTest") {
    inputs.files(fileTree("${project.projectDir}/../consumer-springboot/pacts") { include("*.json") })
}
